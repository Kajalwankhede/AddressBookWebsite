...
function createInnerHTML(){
    ...
    for(const contact of record){
        ...
        <tr>
            ...
            <td>
                <img id="${contact._id}" src="../images/delete-black-18dp.svg" id="${contact._id}" alt="delete" onclick="removeCont(this)"><br>
                <img id="${contact._id}" src="../images/create-black-18dp.svg" id="${contact._id}" alt="edit" onclick="update(this)">
            </td>
        </tr>
    `;
    }
